    ...
    sections: [
        {
            ...
            phrases: [
                "Dans cette section, vous allez pouvoir découvrir une sélection de mes captures.",
    ...
    sections: [
        {
            ...
            phrases: [
                ...
                "Au fil de mon apprentissage des technologies de développement web, s'est imposé l'idée de fusionner ces deux domaines dans le but, d'un côté, de mettre en application ce que j'ai appris, et de l'autre, de pouvoir exposer les fruits de ce loisir.",
            ],
        },
        {
...
export {galleryPageInputs, aboutMePageInputs};
