			...
			<>
				...
				<main className={"homepage"}>
					...
					<div className={"homepage__introduction"}>
						<p className={"introduction__paragraph"}>{"Bonjour, je m'appelle Arnaud !"}<br />{"Développeur web résidant en Belgique, dans la ville de Liège, et amateur de photographie."}</p>
