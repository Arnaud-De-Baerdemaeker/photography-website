				...
				<main className={"homepage"}>
					...
					<div className={"homepage__description"}>
						<div className={"homepage__section"}>
							...
							<p className={"homepage__paragraph"}>{"Vers la fin de ma formation, l'idée de me créer un petit portfolio s'est imposée. L'objectif était multiple : mettre en pratique les connaissances apprises, me présenter, et montrer les fruits de mon intérêt pour la photographie."}</p>
