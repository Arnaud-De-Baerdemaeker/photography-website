    ...
    render() {
        return (
            <>
                ...
                <div>
                    <figure>
                        <img src={me} alt={"Photo de moi"} title={"Oui, c'est moi !"} loading={"lazy"} />
                        <figcaption>{"C'est moi !"}</figcaption>
                    </figure>
                    <div>
                        <h1>{"Qui suis-je ?"}</h1>
                        <p>{"Bonjour ! Je m'appelle Arnaud."}</p>
                        <p>{"Vivant à Liège, en Belgique, je suis développeur web et accessoirement je pratique la photographie comme loisir."}</p>
                    ...
                    <div>
                        ...
                        <p>{"Aujourd'hui, bien que touche-à-tout, j'affectionne particulièrement le fait de construire des designs, rédiger des lignes de code, admirer leur logique, et les voir prendre vie dans le navigateur."}</p>
                    ...
                    <h2>{"Mettez-vous à l'aise et découvrez..."}</h2>
                </div>
            </>
        );
    }
