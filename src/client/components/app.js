        ...
        return (
            <>
                <Helmet>
                    ...
                    <link
                        href={
                            "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Comfortaa:wght@300;400;500;600;700&family=DM+Sans:wght@400;500;700&display=swap"
                        }
                        rel={"stylesheet"}
                    />
                ...
                <BrowserRouter>
                    <Switch>
                        ...
                        <Route exact path={"/gallery/2016"}>
                            <PhotosList album={data[2].album_2016} />
                        </Route>
